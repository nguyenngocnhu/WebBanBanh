    ...
    <div class="products">
        <div class="container px-4">
            ...
            <div class="box-container">
                ...
                <?php
                $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE n = 'dn' LIMIT 6") or die('query failed');
...
<style>
    .ny{
        background-image: url('https://mspmag.com/downloads/39707/download/Donut-Day-1.gif?cb=dc75ba9e0728cac19c55c888fcd757f1');
