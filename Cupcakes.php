...
<body id="page-top">
    ...
    <div class="products">
        <div class="container px-4">
            ...
            <div class="box-container">
                ...
                <?php
                $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE n = 'cc' LIMIT 6") or die('query failed');
    ...
    <style>
        .ny{
            background-image: url('https://img1.picmix.com/output/stamp/normal/7/7/0/0/2090077_9c767.gif');
