...
<section class="quick-view text-black ">
    <h1 class="title text-white">product details</h1>
    <?php  
        if(isset($_GET['pid'])){
            $pid = $_GET['pid'];
    ...
    ?>
     <div class="products">
        <div class="container px-4 ">
            ...
            <div class="box-container text-white">
         ...
         <input class="text-black" type="number" name="product_quantity" value="1" min="0" class="qty">
