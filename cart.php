...
<h3>shopping cart</h3>
    ...
    ?>
    <div  class="box">
        <a href="cart.php?delete=<?php echo $fetch_cart['id']; ?>" class="fa fa-times" onclick="return confirm('delete this from cart?');"></a>
        <a href="view_page.php?pid=<?php echo $fetch_cart['pid']; ?>" class="k fa fa-eye"></a>
        <img src="Cakes/<?php echo $fetch_cart['image']; ?>" alt="" class="image">
